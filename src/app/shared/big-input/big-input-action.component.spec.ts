...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<bhpfd-big-input-action></bhpfd-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<bhpfd-big-input-action [disabled]="true"></bhpfd-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<bhpfd-big-input-action fontSet="fas" fontIcon="fa-trash"></bhpfd-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<bhpfd-big-input-action label="delete"></bhpfd-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<bhpfd-big-input-action (action)="actionHandler()"></bhpfd-big-input-action>`;
    fixture = createHostComponent(template);
